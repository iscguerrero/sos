...
class Catalogo_marcas_dispositivos extends Base_Controller {
	...
	public function index(){
		echo $this->templates->render('supervision/catalogo_marcas_dispositivos');
	}
	...
	public function row(){
		...
		# Comprobamos si se trata de un insert o un update
			$this->input->post('id')==''?$this->ctl_marcas_dispositivos_model->insert_row($data):$this->ctl_marcas_dispositivos_model->update_row($data, $this->input->post('id'));
