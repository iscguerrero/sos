<?$this->layout('master', ['title'=>'Catálogo de Marcas de Dispositivos'])?>
		...
		<div class='modal-dialog modal-sm' role='document'>
			<div class='modal-content'>
				<div class='modal-header'>
					...
					<h4 class='modal-title' id='myModalLabel'><i class = 'fa fa-edit'></i> <strong>Marcas Dispositivos</strong></h4>
				</div>
		...
		$(document).ready(function(){
			...
			// Obtener el data del modelo
				function getRows(){
					...
					$.ajax({
						type: 'POST',
						url: 'supervision/catalogo_modelos_dispositivos/list_rows',
						data: {},
						dataType: 'json',
						async: false,
						beforeSend:function(){
			...
			// Alta nuevo registro
				$('#form_sequence').submit(function(e){
					...
					$.ajax({
						type: 'POST',
						url: 'supervision/catalogo_marcas_dispositivos/row',
						data: str,
						dataType: 'json',
						beforeSend:function(){
